...
* SM parameters
	...
	double precision EL, Alfa, Alfa2, GF, GS, Alfas, Alfas2
        double precision MW, MW2, MZ, MZ2, GW
...
*	parameter (Alfa = 1/131.957983D0, Alfa2 = Alfa**2)
*	parameter (Alfa = 1/128D0, Alfa2 = Alfa**2)
	...
	parameter (MM = 0.51099892D-3, MM2 = MM**2)
	parameter (ME = 105.658369D-3, ME2 = ME**2)
