...
c$$$*	parameter (Alfa = 1/131.953D0, Alfa2 = Alfa**2)
c$$$*	parameter (Alfa = 1/128D0, Alfa2 = Alfa**2)
...
c$$$*	parameter (GZ = 0D0)
c$$$	parameter (GZ = 2.4924D0)
c$$$	parameter (SW2 = (MZ2 - MW2)/MZ2)
c$$$	parameter (CW = MW/MZ, CW2 = CW**2)
c$$$*	parameter (SW2 = 0.23150d0)
c$$$*	parameter (CW = 0.876641, CW2 = CW**2)
c$$$
c$$$	parameter (ME = .51099892D-3, ME2 = ME**2)
c$$$*	parameter (ME = 2.d0, ME2 = ME**2)
c$$$	parameter (MM = 105.658369D-3, MM2 = MM**2)
c$$$	parameter (ML = 1776.99D-3, ML2 = ML**2)
c$$$
c$$$	parameter (MU = 66.D-3, MU2 = MU**2)
c$$$	parameter (MC = 1.2D0, MC2 = MC**2)
c$$$	parameter (MT = 178.D0, MT2 = MT**2)
c$$$
